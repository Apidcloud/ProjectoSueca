...
using Phone.Classes.Controllers;
...
namespace Phone.Classes.Models
{
    public class GameModel
    {
        ...
        public List<Carta> deck { get; private set; }
        ...
        {
            this.deck = (List<Carta>)SerializeData.DeserializeFromXML(filename);
        }
        ...
        public void SerializeToXML(string filename)
        {
           ...
           // myIsolatedStorage.CreateDirectory("MyFolder");
            

            XDocument doc = new XDocument(new XDeclaration("1.0", System.Text.Encoding.UTF8.ToString(), "yes"),
            ...
            doc.Save(new StreamWriter(new IsolatedStorageFileStream(filename, FileMode.Create,FileAccess.Write,FileShare.ReadWrite, myIsolatedStorage)));
        }
        ...
        public void DeserializeFromXML(string filename)
        {
            ...
            isfStream = new IsolatedStorageFileStream(filename, FileMode.Open, FileAccess.Read, myIsolatedStorage);
